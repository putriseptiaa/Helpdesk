...
@section('nav')
    ...
    <li class="nav-item active">
        <a class="nav-link" href="{{ route('pengajuanskpp') }}">Pengajuan Sidang KP</a>
    </li>
@endsection
                                                                        ...
                                                                        @if (isset($data2))
                                                                            @if ($data2->wfreference == '1')
                                                                                <div class="card-header text-center">
                                                                                    <div class="row">
                                                                                        <div class="col-lg-12">
                                                                                            <a href="{{ route('tolakpengajuanskpp', $data2->id) }}"
                                                                                                class="btn btn-sm btn-danger">Tolak
                                                                                                Permintaan</a>
                                                                                            <a href="{{ route('terimapengajuanskpp', $data2->id) }}"
                                                                    ...
                                                                    <div class="card shadow-sm">
                                                                        ...
                                                                        @if ($data3->wfreference == '2')
                                                                            <div class="card-header text-center">
                                                                                <div class="row">
                                                                                    <div class="col-lg-12">
                                                                                        {{-- <a href="{{ route('tolakpengajuanskpp', $data3->id) }}"
                                                                                            class="btn btn-sm btn-danger">Tolak
                                                                                            Permintaan</a> --}}
                                                                                        <a href="{{ route('prosespengajuanskpp', $data3->id) }}"
                                                                    ...
                                                                    <div class="card shadow-sm">
                                                                        ...
                                                                        @if ($data4->wfreference == '2')
                                                                            <div class="card-header text-center">
                                                                                <div class="row">
                                                                                    <div class="col-lg-12">
                                                                                        <a href="{{ route('tolakpengajuanskpp', $data4->id) }}"
                                                                                            class="btn btn-sm btn-danger">Tolak
                                                                                            Permintaan</a>
                                                                                        <a href="{{ route('terimapengajuanskpp', $data4->id) }}"
                                                                                            class="btn btn-sm btn-core">Terima
                                                                                            Permintaan</a>
                                                                                    </div>
                                                                                </div>
