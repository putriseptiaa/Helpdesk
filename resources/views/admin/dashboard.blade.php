                    ...
                    <div class="card-user">
                        <div class="row">
                            ...
                            <div class="col-6 d-flex flex-column justify-content-center align-items-end">
                                ...
                                <div class="card-call"><a href="{{ route('daftar_userr') }}" style="color: #fff"><i class="bi bi-arrow-right-square-fill"></i></a></div>

                                {{-- <div class="card-call">{{ $userr }} <a href="{{ route('daftar_userr') }}" style="color: #fff"><i class="bi bi-arrow-right-square-fill"></i></a></div> --}}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-pengajuan ppskkp">
                        <div class="row">
                            ...
                            <div class="col-6 d-flex flex-column justify-content-center align-items-end">
                                ...
                                <div class="card-call"> <a href="{{ route('pengajuanpskkpp') }}" style="color: #fff"><i class="bi bi-arrow-right-square-fill"></i></a></div>
                            </div>
                        </div>
                    </div>
                </div> 
                    ...
                    <div class="card-pengajuan skp">
                        <div class="row">
                            ...
                            <div class="col-6 d-flex flex-column justify-content-center align-items-end">
                                ...
                                <div class="card-call"> <a href="{{ route('pengajuanskpp') }}" style="color: #fff"><i class="bi bi-arrow-right-square-fill"></i></a></div>
                            </div>
                        </div>
                    </div>
                </div> 
                    ...
                    <div class="card-pengajuan pptakp">
                        <div class="row">
                            ...
                            <div class="col-6 d-flex flex-column justify-content-center align-items-end">
                                ...
                                <div class="card-call"> <a href="{{ route('pengajuanpptakpp') }}" style="color: #fff"><i class="bi bi-arrow-right-square-fill"></i></a></div>
                            </div>
                        </div>
                    </div>
                </div> 
                    ...
                    <div class="card-pengajuan spta">
                        <div class="row">
                            ...
                            <div class="col-6 d-flex flex-column justify-content-center align-items-end">
                                ...
                                <div class="card-call"><a href="{{ route('pengajuansptaa') }}" style="color: #fff"><i class="bi bi-arrow-right-square-fill"></i></a></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-pengajuan spta">
                        <div class="row">
                            ...
                            <div class="col-6 d-flex flex-column justify-content-center align-items-end">
                                ...
                                <div class="card-call"><a href="{{ route('pengajuanpsktaa') }}" style="color: #fff"><i class="bi bi-arrow-right-square-fill"></i></a></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-pengajuan semta">
                        <div class="row">
                            ...
                            <div class="col-6 d-flex flex-column justify-content-center align-items-end">
                                ...
                                <div class="card-call"> <a href="{{ route('pengajuansemtaa') }}" style="color: #fff"><i class="bi bi-arrow-right-square-fill"></i></a></div>
                            </div>
                        </div>
                    </div>
                </div> 
                    ...
                    <div class="card-pengajuan sta">
                        <div class="row">
                            ...
                            <div class="col-6 d-flex flex-column justify-content-center align-items-end">
                                ...
                                <div class="card-call"> <a href="{{ route('pengajuanstaa') }}" style="color: #fff"><i class="bi bi-arrow-right-square-fill"></i></a></div>
                            </div>
                        </div>
                    </div>
                </div> 
                    ...
                    <div class="card-pengajuan legalisasi">
                        <div class="row">
                            ...
                            <div class="col-6 d-flex flex-column justify-content-center align-items-end">
                                ...
                                <div class="card-call"> <a href="{{ route('legalisasii') }}" style="color: #fff"><i class="bi bi-arrow-right-square-fill"></i></a></div>
                            </div>
                        </div>
                    </div>
                </div> 
                    ...
                    <div class="card-pengajuan ulkp">
                        <div class="row">
                            ...
                            <div class="col-6 d-flex flex-column justify-content-center align-items-end">
                                ...
                                <div class="card-call"><a href="{{ route('pengajuanulkpp') }}" style="color: #fff"><i class="bi bi-arrow-right-square-fill"></i></a></div>
                            </div>
                        </div>
                    </div>
                </div>  
                    ...
                    <div class="card-pengajuan ulta">
                        <div class="row">
                            ...
                            <div class="col-6 d-flex flex-column justify-content-center align-items-end">
                                ...
                                <div class="card-call"> <a href="{{ route('pengajuanultaa') }}" style="color: #fff"><i class="bi bi-arrow-right-square-fill"></i></a></div>
                            </div>
                        </div>
                    </div>
                </div> 
                    ...
                    <div class="card-pengajuan bpit">
                       <div class="row">
                            ...
                            <div class="col-6 d-flex flex-column justify-content-center align-items-end">
                                ...
                                <div class="card-call"><a href="{{ route('pengajuanbpitt') }}" style="color: #fff"><i class="bi bi-arrow-right-square-fill"></i></a></div>
                            </div>
                        </div>
                    </div>
                </div>  
