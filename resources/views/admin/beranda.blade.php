...
@section('nav')
    <ul class="navbar-nav mx-auto text-uppercase">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="{{ route('admin.beranda') }}">Dashboard Informasi</a>
        </li>
        {{-- <li class="nav-item dropdown active">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Verifikasi</a>
                <div class="dropdown-menu text-capitalize" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="">Pengusulan SK Kerja Praktek</a>
                    <a class="dropdown-item" href="">Sidang Kerja Praktek</a>
                    <a class="dropdown-item" href="">Perpanjangan KP dan TA</a>
                    <a class="dropdown-item" href="">Sidang Proposal Tugas Akhir</a>
                    <a class="dropdown-item" href="">Pengusulan SK Tugas Akhir</a>
                    <a class="dropdown-item" href="">Seminar Tugas AKhir</a>
                    <a class="dropdown-item" href="">Sidang Tugas Akhir</a>
                    <a class="dropdown-item" href="">Unggah Dokumen Laporan KP</a>
                    <a class="dropdown-item" href="">Unggah Dokumen Laporan TA</a>
                    <a class="dropdown-item" href="">Unggah Bukti Pengambilan Ijazah dan Transkip Nilai</a>
                    <a class="dropdown-item" href="">Legalisasi Dokumen</a>
                </div>
        </li>
        <li class="nav-item active">
