...
@section('nav')
    ...
    <li class="nav-item active">
        <a class="nav-link" href="{{ route('pengajuanbpitt') }}">Bukti Pengambilan Ijazah dan Transkip Nilai</a>
    </li>
@endsection
                                                                            ...
                                                                            @foreach ($data2->transwfbpit as $data3)
                                                                                @if ($data3->wfreference == '1')
                                                                                    <div class="card-header text-center">
                                                                                        <div class="row">
                                                                                            <div class="col-lg-12">
                                                                                                <a href="{{ route('tolakpengajuanbpitt', $data3->id) }}"
                                                                                                    class="btn btn-sm btn-danger">Tolak
                                                                                                    Permintaan</a>
                                                                                                <a href="{{ route('terimapengajuanbpitt', $data3->id) }}"
                                                                                                    class="btn btn-sm btn-core">Terima
                                                                                                    Permintaan</a>
                                                                                            </div>
                                                                                        </div>
