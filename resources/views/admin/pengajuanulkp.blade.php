...
@section('nav')
    ...
    <li class="nav-item active">
        <a class="nav-link" href="{{ route('pengajuanulkpp') }}">Unggah Dokumen Laporan KP</a>
    </li>
@endsection
                                                                                ...
                                                                                @if (isset($data2))
                                                                                    @if ($data2->wfreference == '1')
                                                                                        <div
                                                                                            ...
                                                                                            <div class="row">
                                                                                                <div class="col-lg-12">
                                                                                                    <a href="{{ route('tolakpengajuanulkpp', $data2->id) }}"
                                                                                                        class="btn btn-sm btn-danger">Tolak
                                                                                                        Permintaan</a>
                                                                                                    <a href="{{ route('terimapengajuanulkpp', $data2->id) }}"
