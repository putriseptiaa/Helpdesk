            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav text-uppercase">
                    ...
                    <li class="nav-item active dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item text-capitalize" href="{{ route('administrator.beranda') }}"><i class="bi bi-house"></i> Dashboard</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item text-capitalize" href="{{ route('profileadministrator.index') }}"><i class="bi bi-person-circle"></i> My Profile</a>
                            <div class="dropdown-divider"></div>
