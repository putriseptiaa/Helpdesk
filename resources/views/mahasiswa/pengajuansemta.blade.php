...
@section('nav')
    ...
    <li class="nav-item active">
        <a class="nav-link" href="{{ route('mahasiswa.pengajuansemta') }}">Pengajuan Seminar Tugas Akhir</a>
    </li>
@endsection
@section('content')
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card shadow-sm">
                                <h5 class="card-header">Formulir Pengajuan Seminar TA</h5>
                                <div class="card-body">
                                    <label for="exampleFormControlSelect1">Silahkan isi formulir pengajuan seminar tugas
                                        akhir sesuai dengan persyaratan yang dibutuhkan.</label>
                                    <form method="POST" action="{{ route('pengajuansemtastore') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <select id="jenis_surat" type="text" class="form-control"
                                                    ...
                                                    <option value="semta">Pengajuan Seminar TA</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="upper_seminar"
                                                class="col-md-12 col-form-label text-md-end">{{ __('Pilih Bukti Persetujuan Seminar (Sudah TTD Pembimbing 1 dan 2)') }}</label>

                                            <div class="col-md-12">
                                                <select id="upper_seminar" type="text"
                                                    class="form-control @error('upper_seminar') is-invalid @enderror"
                                                    name="upper_seminar" required autocomplete="upper_seminar">
                                                    <option disabled selected value>Pilih</option>
                                        ...
                                        <div class="card-header">
                                            Jika sudah punya bukti persetujuan seminar
                                            silahkan upload foto formulir permohonan seminar
                                        </div>
                                        <div class="form-group">
                                            <label for="for_seminar"
                                                class="col-md-12 col-form-label text-md-end">{{ __('Upload Foto Formulir Permohonan Seminar') }}</label>
                                            <div class="col-md-12">
                                                <div class="custom-file">
                                                    <input id="for_seminar" type="file"
                                                        class="custom-file-input @error('for_seminar') is-invalid @enderror"
                                                        name="for_seminar" autocomplete="for_seminar" placeholder=""
                                                        accept="image/*">
                                        ...
                                        <div class="form-group">
                                            <label for="lembar_pembimbingta"
                                                class="col-md-12 col-form-label text-md-end">{{ __('Lembar Pembimbing TA (jika ada/ bukti bimbingan digital)') }}</label>

                                            <div class="col-md-12">
                                                <div class="custom-file">
                                                    <input id="lembar_pembimbingta" type="file"
                                                        class="custom-file-input @error('lembar_pembimbingta') is-invalid @enderror"
                                                        name="lembar_pembimbingta" required
                                                        autocomplete="lembar_pembimbingta" placeholder=""
                                                        accept=".pdf,image/*">
                                                    <label class="custom-file-label" for="customFile">Format File berupa
                                                        PDF atau Image (png, jpg, dll)</label>
                                                </div>
                                            </div>
                                            @error('lembar_pembimbingta')
                                                <span class="invalid-feedback" role="alert">
                                                    {{-- <strong>{{ $message }}</strong> --}}
                                                </span>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            <label for="bukti_penyerahan_lapkp"
                                                class="col-md-12 col-form-label text-md-end">{{ __('Upload Bukti Penyerahan Laporan KP') }}</label>

                                            <div class="col-md-12">
                                                <div class="custom-file">
                                                    <input id="bukti_penyerahan_lapkp" type="file"
                                                        class="custom-file-input @error('bukti_penyerahan_lapkp') is-invalid @enderror"
                                                        name="bukti_penyerahan_lapkp" required
                                                        autocomplete="bukti_penyerahan_lapkp" placeholder=""
                                                        accept=".pdf,image/*">
                                                    <label class="custom-file-label" for="customFile">Format File berupa
                                                        PDF atau Image (png, jpg, dll)</label>
                                                </div>
                                            </div>
                                            @error('bukti_penyerahan_lapkp')
                                                <span class="invalid-feedback" role="alert">
                                                    {{-- <strong>{{ $message }}</strong> --}}
                                                </span>
                                            @enderror
                ...
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card shadow-sm">
                                <h5 class="card-header">Track Record Pengajuan Seminar TA</h5>
                                <div class="card-body">
                                    <form>
                                        <div class="form-group">
        ...
        $(document).ready(function() {
            $('#trackSurat').change(function() {
                ...
                if (surat) {
                    $.ajax({
                        type: "get",
                        url: '/mahasiswa/tracing/' + surat + '/pengajuansemta',
